...
.LBB1_29:
	...
	movzwl	2(%rax), %eax
	movl	%eax, -20(%rbp)
	cmpl	PrintFileBanner.CurrentFileNum(%rip), %eax
	je	.LBB1_31
# BB#30:
	movq	fp(%rip), %rbx
	movzwl	-20(%rbp), %edi
