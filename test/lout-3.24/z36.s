...
.LBB1_11:
	...
	jmp	.LBB1_5
.LBB1_18:
	movl	$120000, -56(%rbp)      # imm = 0x1D4C0
...
.LBB1_25:                               #   in Loop: Header=BB1_24 Depth=1
	...
	jmp	.LBB1_26
	.align	16, 0x90
.LBB1_87:                               #   in Loop: Header=BB1_26 Depth=2
	movq	no_fpos(%rip), %r8
	movl	$1, %edi
	movl	$2, %esi
	movl	$.L.str, %edx
...
# BB#29:                                #   in Loop: Header=BB1_26 Depth=2
	...
	jmp	.LBB1_30
	.align	16, 0x90
.LBB1_39:                               #   in Loop: Header=BB1_30 Depth=3
	movq	-80(%rbp), %rax
	leaq	1(%rax), %rcx
	movq	%rcx, -80(%rbp)
	movb	(%rax), %al
...
# BB#32:                                #   in Loop: Header=BB1_30 Depth=3
	...
	jmp	.LBB1_33
	.align	16, 0x90
.LBB1_35:                               #   in Loop: Header=BB1_33 Depth=4
	addl	$3, -84(%rbp)
...
# BB#37:                                #   in Loop: Header=BB1_30 Depth=3
	...
	movq	%rax, -80(%rbp)
	jmp	.LBB1_30
.LBB1_38:                               #   in Loop: Header=BB1_30 Depth=3
	movq	no_fpos(%rip), %r8
	movq	-56(%rbp), %r9
	movl	-68(%rbp), %eax
	movl	%eax, (%rsp)
...
# BB#43:                                #   in Loop: Header=BB1_26 Depth=2
	...
	movq	%rbx, %r9
	callq	Error
.LBB1_44:                               #   in Loop: Header=BB1_26 Depth=2
	movl	$1, -176(%rbp)
	jmp	.LBB1_26
.LBB1_45:                               #   in Loop: Header=BB1_26 Depth=2
	movl	$.L.str.17, %esi
	movq	%r13, %rdi
	callq	strcmp
	testl	%eax, %eax
	je	.LBB1_46
# BB#47:                                #   in Loop: Header=BB1_26 Depth=2
	movl	$.L.str.18, %esi
	movq	%r13, %rdi
	callq	strcmp
	testl	%eax, %eax
...
# BB#49:                                #   in Loop: Header=BB1_26 Depth=2
	...
	testl	%eax, %eax
	je	.LBB1_50
# BB#51:                                #   in Loop: Header=BB1_26 Depth=2
	movq	-120(%rbp), %rax
	movq	%r13, -48(%rbp)
	movq	%rax, -56(%rbp)
	movl	292(%rax), %ecx
	cmpl	288(%rax), %ecx
	je	.LBB1_53
# BB#52:                                #   in Loop: Header=BB1_26 Depth=2
	movq	no_fpos(%rip), %r8
	movl	$1, %edi
	movl	$2, %esi
	movl	$.L.str, %edx
...
.LBB1_53:                               #   in Loop: Header=BB1_26 Depth=2
	...
	jmp	.LBB1_54
	.align	16, 0x90
.LBB1_57:                               #   in Loop: Header=BB1_54 Depth=3
	movq	no_fpos(%rip), %r8
	movslq	-64(%rbp), %rax
	movq	-48(%rbp), %rcx
	movzbl	(%rcx,%rax), %r9d
	...
	callq	Error
	incl	-64(%rbp)
.LBB1_54:                               #   Parent Loop BB1_24 Depth=1
                                        #     Parent Loop BB1_26 Depth=2
...
# BB#56:                                #   in Loop: Header=BB1_54 Depth=3
	...
	incl	-64(%rbp)
	jmp	.LBB1_54
.LBB1_59:                               #   in Loop: Header=BB1_26 Depth=2
	movl	$.L.str.18, %esi
	movq	%r13, %rdi
	callq	strcmp
	testl	%eax, %eax
	je	.LBB1_60
# BB#61:                                #   in Loop: Header=BB1_26 Depth=2
	movl	$.L.str.19, %esi
	movq	%r13, %rdi
	callq	strcmp
	testl	%eax, %eax
	je	.LBB1_62
# BB#63:                                #   in Loop: Header=BB1_26 Depth=2
	movl	$56, -160(%rbp)
	movl	$0, -168(%rbp)
	movslq	-168(%rbp), %rax
	movb	$46, -1216(%rbp,%rax)
	movb	-160(%rbp), %al
	movslq	-168(%rbp), %rcx
	leal	1(%rcx), %edx
	movl	%edx, -168(%rbp)
	movb	%al, -1728(%rbp,%rcx)
	movl	$56, -160(%rbp)
	movl	$0, -164(%rbp)
	jmp	.LBB1_64
	.align	16, 0x90
.LBB1_66:                               #   in Loop: Header=BB1_64 Depth=3
	movl	$57, -160(%rbp)
	incl	-164(%rbp)
.LBB1_64:                               #   Parent Loop BB1_24 Depth=1
                                        #     Parent Loop BB1_26 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	movslq	-164(%rbp), %rax
	cmpb	$0, -704(%rbp,%rax)
...
# BB#67:                                #   in Loop: Header=BB1_64 Depth=3
	...
	incl	-164(%rbp)
	jmp	.LBB1_64
.LBB1_73:                               #   in Loop: Header=BB1_26 Depth=2
	movl	$.L.str.18, %esi
	movq	%r13, %rdi
	callq	strcmp
	testl	%eax, %eax
	je	.LBB1_74
# BB#75:                                #   in Loop: Header=BB1_26 Depth=2
	movl	$.L.str.21, %esi
	xorl	%eax, %eax
	movq	%r13, %rdi
	leaq	-184(%rbp), %rdx
	...
	je	.LBB1_26
	jmp	.LBB1_76
.LBB1_77:                               #   in Loop: Header=BB1_26 Depth=2
	movl	$48, -160(%rbp)
	movl	$0, -168(%rbp)
	movl	$0, -164(%rbp)
	jmp	.LBB1_78
...
.LBB1_82:                               #   in Loop: Header=BB1_78 Depth=3
	...
	movl	$48, -160(%rbp)
	incl	-164(%rbp)
.LBB1_78:                               #   Parent Loop BB1_24 Depth=1
                                        #     Parent Loop BB1_26 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	movslq	-164(%rbp), %rax
	cmpb	$0, -704(%rbp,%rax)
...
# BB#80:                                #   in Loop: Header=BB1_78 Depth=3
	...
	cmpl	$57, %eax
	jg	.LBB1_82
# BB#81:                                #   in Loop: Header=BB1_78 Depth=3
	movslq	-164(%rbp), %rax
	movzbl	-704(%rbp,%rax), %eax
	movl	%eax, -160(%rbp)
	incl	-164(%rbp)
	jmp	.LBB1_78
.LBB1_83:                               #   in Loop: Header=BB1_26 Depth=2
	movslq	-168(%rbp), %rax
	movb	$0, -1216(%rbp,%rax)
	movb	-160(%rbp), %al
	movslq	-168(%rbp), %rcx
	...
	cmpl	$0, -184(%rbp)
	je	.LBB1_85
# BB#84:                                #   in Loop: Header=BB1_26 Depth=2
	movl	-168(%rbp), %eax
	cmpl	-184(%rbp), %eax
	jg	.LBB1_26
.LBB1_85:                               #   in Loop: Header=BB1_26 Depth=2
	movq	-120(%rbp), %rdx
	movq	-136(%rbp), %rcx
	addq	$64, %rcx
	movl	-180(%rbp), %r8d
	...
	jne	.LBB1_26
	jmp	.LBB1_86
.LBB1_68:                               #   in Loop: Header=BB1_26 Depth=2
	movslq	-168(%rbp), %rax
	movb	$46, -1216(%rbp,%rax)
	movb	-160(%rbp), %al
	movslq	-168(%rbp), %rcx
	...
	jne	.LBB1_26
	jmp	.LBB1_69
.LBB1_46:                               #   in Loop: Header=BB1_26 Depth=2
	movl	$2, -176(%rbp)
	jmp	.LBB1_26
.LBB1_60:                               #   in Loop: Header=BB1_26 Depth=2
	movl	$4, -176(%rbp)
	jmp	.LBB1_26
.LBB1_74:                               #   in Loop: Header=BB1_26 Depth=2
	movl	$4, -176(%rbp)
	jmp	.LBB1_26
.LBB1_58:                               # %AddClassToTrie.exit
                                        #   in Loop: Header=BB1_26 Depth=2
	movq	-56(%rbp), %rax
	incl	4(%rax)
	jmp	.LBB1_26
.LBB1_48:                               #   in Loop: Header=BB1_26 Depth=2
	movl	$4, -176(%rbp)
	jmp	.LBB1_26
.LBB1_62:                               #   in Loop: Header=BB1_26 Depth=2
	movl	$3, -176(%rbp)
	jmp	.LBB1_26
.LBB1_50:                               #   in Loop: Header=BB1_26 Depth=2
	movl	$3, -176(%rbp)
	jmp	.LBB1_26
	.align	16, 0x90
...
.LBB1_90:
	...
	jmp	.LBB1_91
	.align	16, 0x90
.LBB1_94:                               #   in Loop: Header=BB1_91 Depth=1
	incl	-68(%rbp)
...
# BB#106:
	...
	jmp	.LBB1_107
	.align	16, 0x90
.LBB1_108:                              #   in Loop: Header=BB1_107 Depth=1
	movslq	-164(%rbp), %rax
	movq	-120(%rbp), %rcx
	movq	280(%rcx), %rcx
	movsbl	(%rcx,%rax), %edi
...
# BB#119:                               #   in Loop: Header=BB1_118 Depth=1
	...
	cmpl	$-1, %eax
	je	.LBB1_121
# BB#120:                               #   in Loop: Header=BB1_118 Depth=1
	movb	-172(%rbp), %al
	movslq	-164(%rbp), %rcx
	movq	-120(%rbp), %rdx
	movb	%al, 8(%rdx,%rcx)
...
.LBB1_122:
	...
	jmp	.LBB1_123
	.align	16, 0x90
.LBB1_127:                              #   in Loop: Header=BB1_123 Depth=1
	incl	-164(%rbp)
...
# BB#125:                               #   in Loop: Header=BB1_123 Depth=1
	...
	cmpl	$-1, %eax
	je	.LBB1_127
# BB#126:                               #   in Loop: Header=BB1_123 Depth=1
	movzbl	-172(%rbp), %eax
	movslq	-164(%rbp), %rcx
	movq	-120(%rbp), %rdx
	movq	264(%rdx), %rdx
...
.LBB4_9:
	...
	retq
.Lfunc_end4:
	.size	BeGetInt, .Lfunc_end4-BeGetInt
	.cfi_endproc
...
# BB#5:
	...
	retq
.Lfunc_end5:
	.size	NewTrieNode, .Lfunc_end5-NewTrieNode
	.cfi_endproc
